...
fields per dog). An document of improved column names focused on readability is
provided in the reference directory (`references/readable_column_names.csv`).
...
We start by dropping all columns that will not be used during either the tidying
process or analysis.
