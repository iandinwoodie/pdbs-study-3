...
#str(df)
stopifnot(identical(dim(df)+0, c(1308, 280)))
...
df <- df[, idx]
dim(df)
#stopifnot(identical(dim(df)+0, c(1305, 83)))
```
...
summary(df)
#stopifnot(identical(dim(df)+0, c(1296, 83)))
```
...
#stopifnot(identical(dim(df)+0, c(1296, 77)))
summary(df)
```
